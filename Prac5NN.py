...
if __name__ == "__main__":  # Test what we have done
    ...
    nn = Full_NN(2, [8, 12], 1)  # creates a NN with 2 inputs, 2 hidden layers and 1 output
    nn.train_nn(training_inputs, targets, 50, 0.005)  # trains the network with 0.1 learning rate for 10 epochs
